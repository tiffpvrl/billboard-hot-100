...
1.  The top 10 longest-running #1 songs of all time; and

2.  The single longest-running #1 song from each decade
...
structure_chart <- ggplot(data = bb_artist, aes(x = decade, fill = artist_type)) +
  ...
  labs(
    title = "How Has Artist Structure Changed?",
    x = "Decade",
    y = "Song Proportion"
  ) +
  coord_flip()
